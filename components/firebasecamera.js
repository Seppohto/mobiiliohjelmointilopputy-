...
// Editing this file with fast refresh will reinitialize the firebasecamera on every refresh, let's not do that
if (!getApps().length) {
...
export default class Firebasecamera extends React.Component {
  state = {
    image: null,
    uploading: false,
  };
